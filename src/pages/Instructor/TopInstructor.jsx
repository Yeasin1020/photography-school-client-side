  ...
  return (
	...
	<div className="container p-4 mx-auto space-y-16 sm:p-10">
		<div className="space-y-4">
			...
			<p className="max-w-2xl dark:text-gray-400">Top Instructor</p>
		</div>
...

    {
      ...
      <div className="flex flex-col">
					<h4 className="text-xl font-semibold">{ins.name}</h4>
					<p className="text-sm dark:text-gray-400">Senior Instructor</p>
